...
def slide_sclgodown(): #안됨, 목록아래로이동
    pass
def slide_slcgoup(): #안됨, 목록위로이동
    pass
    # selected = lstb_r.curselection()
    # for i in selected:
    #     if i == "0" or "1":
    #         print("error")
    #     else:
...
lbl_pptframe = Label(combineframe2, text="")
lbl_pptframe.pack(padx=5, pady=5)
btn_slc_goup = Button(combineframe2, text="위로 이동", width=10, command = slide_slcgoup)
btn_slc_goup.pack(padx=5, pady=5)
btn_slc_godown = Button(combineframe2, text="아래로 이동", width=10, command = slide_sclgodown)
